...
const deployedContracts = {
  11155111: {
    DEX: {
      address: "0xe77D4DAa3B9Cf49a9C9C4431c645311046DA3C48",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9959356,
    },
    MyUSD: {
      address: "0xa2c1cc7031f4D588198E771A5c0231391634f621",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9959355,
    },
    MyUSDEngine: {
      address: "0xfe3419012e9A7C40364b2CF4367012B3eD3D0060",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9959359,
    },
    MyUSDStaking: {
      address: "0x8FEdc98147C1a55f6F87E65220Aa7E72CB671789",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9959358,
    },
    Oracle: {
      address: "0xf5a99c99aBf774d93433bb5B01E6b9A5fA9e88A2",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9959357,
    },
    RateController: {
      address: "0x4a7F64BFA81C93Dc5FE350c9D02D12B54673B830",
      abi: [
        {
          inputs: [
            {
